      ...
      <div className=' px-5 py-8 lg:p-10 flex justify-evenly flex-col-reverse xl:flex-row'>
          ...
          <ScrollScale>
            ...
            <ScrollScale>
              <div className='vision bg-[var(--card)] px-4 py-4 rounded-lg shadow-xl mt-5'>
                  ...
                  <p className="text-[15px] lg:text-lg font-kanit font-extralight text-start mt-2 text-[var(--color3)]">At Prime Workers, our vision is that we are committed to continuous improvement, sustainability & to build a long lasting partnership with our clients.</p>
              </div>
            </ScrollScale>
            <ScrollScale>
              <div className='vision bg-[var(--card)] px-4 py-4 rounded-lg shadow-xl mt-5'>
                  <h1 className='text-[var(--color4)] font-oswald font-semibold  text-2xl lg:text-3xl'>Our Misson</h1>
                  <p className="text-[15px] lg:text-lg font-kanit font-extralight text-start mt-2 text-[var(--color3)]">Our mission is to provide superior services that combines precision, innovation & reliability we are dedicated to meeting the unique needs of each & every clients by delivering the perfect solutions.</p>
              </div>
            </ScrollScale>
        </div>
        ...
        <ScrollScale>
          <div className='right flex xl:relative flex-col '>
              ...
              <h1 className='bg-[var(--card)] rounded-t-lg text-center lg:text-start text-[var(--color2)] fonr-kanit p-5 text-[15px] font-light lg:mx-10 xl:w-[60%] xl:absolute xl:-right-10 xl:bottom-0'>I Mr. Idrees Siddiqui the founder & managing director of this esteemed company. At Prime Workers we offer a large variety of services & try to meet the expectations of our clients by giving the best of us</h1>
          </div>
        </ScrollScale>
